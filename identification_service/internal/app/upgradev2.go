...
func (i *Implementation) UpgradeV2(ctx context.Context, req *desc.UpgradeRequest) (*desc.UpgradeResponse, error) {
...
func validateUpgradeV2(req *desc.UpgradeRequest) error {
